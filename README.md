...
- **_Un método es un bloque de código que contiene una serie de instrucciones.
- Un programa hace que se ejecuten las instrucciones al llamar al método y especificando los argumentos de método necesarios._**
